...
const checks = [
  { file: 'js/i18n.js', includes: ['function t(', 'function tPair(', 'function mbLocale(', 'applyDomI18n', 'function mbEmptyRow('] },
  ...
  { file: 'js/job-market.js', includes: ['loadJobMarketPage', 'createJobPost', 'withdrawJobPost', 'submitJobSubmission', 'loadJobMarketKpi', 'loadJobPermissionsSettings', 'undoJobPolygonPoint', 'importJobPolygon', 'exportJobPolygon'] },
