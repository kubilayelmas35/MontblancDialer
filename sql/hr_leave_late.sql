-- Montblanc Dialer — İzin talepleri & geç kalma kayıtları
-- Kaynak: supabase/migrations/20260413053717_hr_leave_late.sql (canlı DB’ye migration olarak uygulandı.)
-- Yedek / inceleme için; tekrar çalıştırmak genelde gereksiz (IF NOT EXISTS).
...
-- Service role tam erişim (genelde service_role JWT ile bypass edilir; şema tutarlılığı için)
