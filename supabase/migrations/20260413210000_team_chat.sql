...
-- Uygulama service_role ile REST kullanır.
...
create index if not exists chat_messages_firm_idx on public.chat_messages(firm_id);
...
-- Storage (public okuma; yükleme service_role ile)
